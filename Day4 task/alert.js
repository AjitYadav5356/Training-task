...
for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
    var anct = data_1[_i];
    announcement +=
        "\n    <div style=\"background-color:".concat(anct.color, ";\">\n        <div class=\"name-image\">\n            <p> PA ").concat(anct.name, " </p>\n            <img src=\"").concat(anct.image, "\" alt=\"checked\" class=\"checkImage\">\n        </div>\n        <p> ").concat(anct.info, " </p>\n        <p> ").concat(anct.course, " ").concat(anct.courseName, " </p>\n        <div class=\"file-date\" style=\"color:#6E6E6E;\"> \n           <p> <img src=\"").concat(anct.fileImage, "\" class=\"attachImage\"> ").concat(anct.fileInfo, " </p>\n            <p> ").concat(anct.date, " </p>\n\n        </div>\n        <hr> \n    </div>  \n    \n    ");
}
// announcement+=`
